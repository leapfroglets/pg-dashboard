...
class AddColumns extends Component{
  ...
  createTable(){
    ...
    this.state.values.map(value => {
      ...
      concatValues = concatValues + `${value['columnName']} ${value['dataType']}${lengthString}${nullString},`;
    ...
    if(flag){
      concatValues = concatValues + `primary key(${primaryKeyString.slice(0,primaryKeyString.length-1)})`;
    }
    else{
